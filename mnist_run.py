...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.ConvTranspose2d(1, 16, 3,stride = 2,padding=1)
        self.conv2 = nn.ConvTranspose2d(16, 32, 3,stride = 2,padding=1)
        self.conv3 = nn.ConvTranspose2d(32, 64, 3,stride = 2,padding=1)
        # self.conv4 = nn.ConvTranspose2d(64, 32, 3,stride = 2)
        ...
        self.fc1 = nn.Linear(40000, 8000)
        self.fc2 = nn.Linear(8000, 10)
